                            ...
                            <div class="card-body">
                              <h4 class="card-title">Update Room</h4>
                                <div class="form-validation">
                                    <form class="" action="index.php?action=uInfokamar&id=" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                            <input type="file" class="form-control" id="foto" name="foto" placeholder="Input image..." required>
                                        </div>
